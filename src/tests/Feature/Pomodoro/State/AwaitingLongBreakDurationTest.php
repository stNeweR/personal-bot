...
final class AwaitingLongBreakDurationTest extends TestCase
{
    ...
    public function test_awaiting_long_break_duration_user_not_found(): void
    {
        $data = $this->telegramMessageProvider('15');
    ...
    public function test_awaiting_long_break_duration_success(): void
    {
        $data = $this->telegramMessageProvider('15');
        $chatId = $data['message']['from']['id'];
        ...
        $this->assertTelegramMessageSent($chatId, __('pomodoro.long_break_duration_saved'));
